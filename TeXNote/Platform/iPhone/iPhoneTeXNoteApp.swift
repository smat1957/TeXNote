        ...
        WindowGroup {
            GeometryReader { geometry in
                iOSTeXNoteRootView(
                    ...
                    showsAuthenticationInSidebar: false,
                    initialCompactColumn: .detail,
                    extendsDetailIntoTopSafeArea: true,
                    detailTopSafeAreaInset: geometry.safeAreaInsets.top
                ) {
                    iPhoneAuthenticationSettingsView(
                        authenticationSession: authenticationSession
                    )
                }
...
private struct iPhoneAuthenticationSettingsView: View {
